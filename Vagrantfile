...
apt-get update
apt-get install -y  git curl php7.1-bcmath php7.1-bz2 php7.1-cli php7.1-curl php7.1-intl php7.1-json php7.1-mbstring php7.1-opcache php7.1-soap php7.1-sqlite3 php7.1-xml php7.1-xsl php7.1-zip
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.provider "virtualbox" do |vb|
    ...
    vb.customize ["modifyvm", :id, "--name", "Asset Manager ZF- Ubuntu 16.04"]
  end
end
